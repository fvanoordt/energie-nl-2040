...
**Waarom de batterij in Krapte-uren (dagcyclus) verhoudingsgewijs het meest doet:** de ontlading over de drie tekort-segmenten (Schaarste, Krapte-dagcyclus, Krapte-meerdaags) wordt verdeeld naar expliciete gewichten (0,5 / 1,6 / 0,4) — niet naar hoe ernstig het tekort is, maar naar hoe goed een batterij met maar 4-6 uur ontlaadvermogen bij dát type tekort past. Dagcyclus is een kort, dagelijks terugkerend gat — precies waar een korte-duur-batterij voor gemaakt is. Schaarste en meerdaags zijn beide uitgerekte gebeurtenissen (potentieel dagenlang) die de ontlaadduur van een batterij ver overstijgen, ongeacht hun ernst.
...
| Gas CCGT (variabel) | €50 / €77 / €115/MWh | Laag/Midden/Hoog — brandstof+CO₂+opex, weerspiegelt TTF-marktvolatiliteit (~€20-26/MWh eind 2025 tot >€100/MWh bij aanhoudende schaarste). Toggle in de besturing — bepaalt de gas-LCOE overal in de tool. Capaciteit apart via capaciteitsmechanisme |
| Gas+CCS (variabel) | €108 / €135 / €173/MWh | Zelfde drie scenario's + een vaste CCS-meerkost van €58 (afvang/opslag/transport, schaalt niet mee met de brandstofprijs); afvangrate 90%; capaciteit apart |

**Waarom gas wél een prijsscenario heeft en wind/zon/kern niet:** die laatste drie lopen via LCOE + de eigen kannibaliseringscurve van dit model — geen van beide is ooit tegen een waargenomen marktprijs getoetst. Gas is de enige technologie waar dit model iets in de buurt van een marktprijs-benadering gebruikt (brandstof+CO₂, met TTF als impliciete referentie), en gasprijzen zijn nu eenmaal aantoonbaar volatiel (van ~€20/MWh tot >€100/MWh binnen enkele jaren — zie o.a. de TTF-schommelingen 2021-2026). PBL publiceert zelf een laag/midden/hoog-bandbreedte voor gas- en elektriciteitsprijzen 2025-2040 (KEV); bovenstaande getallen zijn een marktdata-afgeleide schatting, geen letterlijk PBL-cijfer. De CCS-meerkost blijft in alle drie scenario's exact €58, omdat die over capex voor afvang/opslag/transport gaat, niet over brandstof.
| Batterijen + V2G | €95/MWh cycluskost | 2040-schatting (Storage Lab, Ember Energy); send-out 4-6 uur; incl. bidirectioneel laden EVs. Volledige LCOS — geen aparte kapitaalslast elders. Toegepast op de daadwerkelijk geladen energie, zichtbaar als aparte regel "Batterij (cycluskost)" in de kostenopbouw. Ontlading is 10% lager dan lading (round-trip-rendement) |
| Batterij-cyclusaanname | 200 / 275 / 350 cycli/jaar | Toggle in de besturing — aggregaat over grid-batterijen + V2G samen. Toegewijde utility-scale arbitragebatterijen halen doorgaans 1-2 cycli/dag (300-365+/jaar); V2G is beperkter, richting 100-200/jaar voor het grid-aandeel |

**Mogelijke overlap bij wind offshore:** SDE++-basisbedragen (waar het €117/MWh-cijfer vandaan komt) bevatten sinds 2025 een profiel- en onbalansfactor die specifiek corrigeert voor het feit dat windproductie samenvalt met lagere marktprijzen — feitelijk al een vorm van kannibalisering, voor een nabije-termijn bouwscenario. Onze eigen kannibaliseringsopslag rekent daar bovenop verder. Getest effect: bij het huidige geïnstalleerde vermogen (6,4 GW, geen nieuwbouw) voegt onze opslag €5/MWh toe; bij zo'n 15-20 GW (een plausibele aanname achter het SDE++-cijfer) €17-24/MWh — het verschil, en dus het reële dubbeltellingsrisico, is daar nog altijd bescheiden (~€12-19/MWh) ten opzichte van wat er bij hogere penetratie bijkomt. Bij de hogere penetraties die dit model juist onderzoekt (22-35 GW) loopt de opslag op tot €26-85/MWh — grotendeels nieuwe informatie die een SDE++-cijfer voor een 15-20 GW-scenario onmogelijk al kan bevatten.
...
**Waarom deze tekst het over marktprijzen heeft, terwijl het model ze niet berekent:** bij 6,4 GW wind (vandaag, geen nieuwbouw) is er vrijwel geen overschot — de opslag op wind bedraagt €5/MWh. Bij 35 GW (het maximumscenario van deze tool) loopt het overschot-aandeel in de overschot-uren op tot 84%, en stijgt diezelfde opslag naar €68/MWh. Die stijging komt volledig uit een volumeverhouding — TWh overschot gedeeld door TWh vraag — vermenigvuldigd met een vaste, vooraf gekalibreerde parameter (45% bij vol overschot, zie tabel hieronder); er wordt nergens een marktprijs berekend. Waarom dan toch over marktprijzen praten? Omdat dát de werkelijke, onderliggende reden is waaróm meer overschot een technologie duurder maakt: in de praktijk daalt de day-ahead-prijs tijdens overaanbod-uren, soms tot nul of negatief, en die prijsval treft alle MWh die op dat moment wordt geproduceerd — niet alleen de MWh die uiteindelijk wordt gecurtailed. Curtailment is het uiterste symptoom van datzelfde prijseffect (de prijs is zo laag dat er geen koper meer is), niet de oorzaak zelf. De vaste parameters hieronder zijn ooit gekalibreerd tegen Hirth's marktwaarde-onderzoek (2013/2015) — de marktprijslogica zit dus wél verwerkt, maar in die kalibratie, niet in een live berekening. Precies zoals de rest van dit model laat zien dat niets op zichzelf staat: ook de aannames achter de aannames zijn geen losse getallen, maar afgeleid van een onderliggend mechanisme.

| Technologie | Opslag: Gebalanceerd-scenario / max. binnen sliderbereik | Reden |
|---|---|---|
| Wind offshore | +22% / +39% | Gecorreleerde productie; hogere WACC bij lage verwachte marktprijzen |
| Zon | +31% / +51% | Sterke dagcorrelatie; zomermiddag-concentratie |
| Kern | +31% / +70% | Lange investeringshorizon + baseload-inflexibiliteit; interconnectie helpt minder |
...
**Ter schaal (bron: NESO/Modo Energy, UK):** het Verenigd Koninkrijk curtailde in 2025 ruim 10 TWh wind, met £1,46 mrd aan totale constraint-kosten — waarvan slechts £363 mln (25%) daadwerkelijke compensatie aan generators was en £1+ mrd (69%) de kost van vervangende opwek (vnl. gas) elders in het net, een transportknelpunt-specifieke kost die bij Nederland-als-koperen-plaat niet op deze manier optreedt.

**Systeemkosten dekken de volledige waarde van weggegooide energie niet.** De expliciete curtailment-opslag in dit model (`curtailmentRate × 50`, bijv. €13/MWh bij 26% curtailment — ca. €2,1 mld/jaar bij 160 TWh vraag) is een gestileerde financieringsrisico-opslag, geen letterlijke waardering van de weggegooide MWh's zelf. Gewaardeerd tegen de volledige effectieve kostprijs van wind/zon komt de weggegooide energie in het Gebalanceerd-scenario uit op circa €5,5-6,3 mrd/jaar — de expliciete opslag dekt daarvan dus maar zo'n derde. De kannibaliseringsopslag vangt een deel van de rest indirect op, maar is breder dan alleen curtailment: die weerspiegelt lage marktwaarde tijdens álle overschot-uren, niet specifiek de MWh's die daadwerkelijk worden weggegooid.

**Waarom deze opslag desondanks niet is verhoogd:** `surplusFrac`, de motor achter de kannibaliseringsopslag, is gebaseerd op het rúwe overschot vóórdat dat wordt toegewezen aan batterij, export of curtailment — de opslag weegt dus al mee hoeveel overaanbod er is, ongeacht wat daarmee gebeurt. Een aparte, grotere kost specifiek voor de weggegooide MWh's zou dus deels dezelfde onderliggende verklaring (veel overschot → lage waarde) via twee kanalen tegelijk meetellen. Bovendien raakt deze specifieke knop direct een politiek gevoelige afweging (hernieuwbaar-zwaar versus kern-zwaar) — bij die combinatie van dubbeltellingsrisico én gevoeligheid is transparant documenteren veiliger dan het cijfer corrigeren.
...
| **Overschot-uren (matig)** | ~2.000 | Redelijk wind/zon, gemiddelde vraag — surplus mogelijk, bij lage bouw ook een klein tekort mogelijk | Wind+zon, export, batterijlading (soms gas) |
...
**Bekende resterende onderschatting (~3-5 procentpunt):** de wind-capaciteitsfactor per segment is direct en kwalitatief gekozen ("hoe winderig is dit segment"), niet afgeleid uit een volledige Weibull-verdeling van windsnelheden geïntegreerd over de vermogenscurve van een turbine. Die curve loopt sterk op (ruwweg met de derde macht van de windsnelheid) tot aan de rated speed, en vlakt daarna af. Bij een gemiddelde windsnelheid ín dat oplopende deel levert een volledige verdeling structureel méér energie op dan "het vermogen bij de gemiddelde windsnelheid" zou suggereren — Jensen's ongelijkheid, een bekend effect in windenergie-onderzoek. Een illustratieve berekening met reële Noordzee Weibull-parameters (K13-platform, vorm k≈2,2, schaal≈9 m/s) laat rond de 8 m/s gemiddelde windsnelheid een verschil van ordegrootte factor 2 zien (14% vs. 29% capaciteitsfactor). Dit treft vooral de **Krapte-segmenten** (waar de curve nog convex is) — niet Overschot-uren (hoog), waar de gemiddelde windsnelheid al dicht bij de rated speed ligt en de curve afvlakt (een naïeve schatting kan daar eerder te hóóg dan te laag uitvallen). Een voorzichtige, illustratieve gevoeligheidstest (Krapte-segmenten +33-35%, conservatief t.o.v. het volledig berekende effect) laat de niet-fossiel- en klimaatneutraal-percentages met circa 3-5 procentpunt stijgen. Nog niet doorgevoerd in het model zelf: daarvoor is een gevalideerde naafhoogte-Weibull-verdeling (~100-140m, moderne turbines) nodig, plus een verdedigbare vertaling van marktsegment naar windsnelheidsbereik. Tot die validatie er is: reken bij "waarom kom ik niet boven de 75-77%"-discussies met een indicatieve +3 à +5 procentpunt.
